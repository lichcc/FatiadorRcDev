spriteCow.ImgInput = (function() {
	function ImgInput($container, $dropZone, tutorialUrl) {
		var imgInput = this,
			...
			$selectButton = $('<div role="button" class="select-btn lg-button">Carregar Imagem</div>').appendTo( $buttons ),
			$demoButton = $('<div role="button" class="demo-btn lg-button">Usar Exemplo</div>').appendTo( $buttons ),
